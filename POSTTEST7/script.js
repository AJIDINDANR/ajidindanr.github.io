...
// Fungsi untuk mengaktifkan/dematikan dark mode
function toggleDarkMode() {
    const body = document.body;
    body.classList.toggle("dark-mode"); // Toggle class dark-mode pada elemen body
}

// Dapatkan tombol "Dark Mode" dan tambahkan event listener
